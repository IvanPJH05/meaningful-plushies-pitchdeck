...
export const storyItems = [
  ...
  },
  {
    id: 'sample-video',
    type: 'video',
    src: assetUrl('/assets/plush-unboxing.mp4'),
    poster: assetUrl('/assets/meaningful-cloud-cover.png'),
    start: 0.24,
    end: 0.44,
    kicker: 'Scrub',
    headline: 'Use scroll to control the unboxing moment frame by frame.',
    body: 'Drop a product video at /public/assets/plush-unboxing.mp4 and the component maps local scroll progress to video currentTime.',
    fallbackBody: 'Video fallback active until a plush unboxing MP4 is added.',
    animation: {
